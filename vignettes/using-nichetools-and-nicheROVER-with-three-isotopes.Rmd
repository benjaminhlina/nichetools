...
You will notice that $\delta$<sup>34</sup>S has been selected for this analysis which differs compared to the other vignette focused on using `{nichetools}` with `{nicheROVER}` for two isotopes. 
